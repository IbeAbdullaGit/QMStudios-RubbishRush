...
public:
	...
	void SetMorphMeshRenderer(MeshResource::Sptr baseMesh,
		Material::Sptr mat);
	...
	void UpdateData(MeshResource::Sptr frame0, MeshResource::Sptr frame1, float t);
	virtual void Draw();
...
protected:
	...
	MeshResource::Sptr m_frame0;
	MeshResource::Sptr m_frame1;
